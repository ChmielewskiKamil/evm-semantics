...
// split into two rules to avoid #if..#then..#else of sort K
...
// avoid #if..#then..#else of sort K by splitting into 4 rules
//    rule <k> #gas [ OP , AOP ]
